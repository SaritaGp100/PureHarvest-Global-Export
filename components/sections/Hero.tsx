        ...
        <div className="grid w-full items-center gap-14 lg:grid-cols-[1.15fr_0.85fr]">
          ...
          >
            ...
            <p className="mt-7 max-w-2xl text-base leading-8 text-slate-300 sm:text-lg md:text-xl">
              ...
              procurement, documentation, and export shipments according to
              buyer requirements.
            </p>
            ...
            <div className="mt-12 border-t border-white/10 pt-7">
              ...
              <div className="grid grid-cols-1 gap-6 sm:grid-cols-3">
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <p className="text-sm font-semibold text-white">
                      Indian Spice Sourcing
                    </p>

                    <p className="mt-1 text-xs leading-5 text-slate-400">
                      Connecting global buyers with suitable Indian suppliers
                    </p>
                  </div>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <p className="text-sm font-semibold text-white">
                      Buyer-Focused Supply
                    </p>

                    <p className="mt-1 text-xs leading-5 text-slate-400">
                      Specifications, quantities and packaging as required
                    </p>
                  </div>
              ...
              <div className="relative overflow-hidden rounded-[2rem] border border-white/15 bg-slate-950/65 p-8 shadow-2xl backdrop-blur-xl">
                ...
                <div className="relative">
                  ...
                  <h2 className="mt-4 text-2xl font-bold leading-tight text-white">
                    Your Indian spice sourcing and export partner.
                  </h2>


                  <p className="mt-4 text-sm leading-7 text-slate-300">
                    We source Indian spices through suitable suppliers and
                    coordinate product requirements, commercial discussions,
                    documentation, and shipment arrangements for international
                    buyers.
                  </p>
