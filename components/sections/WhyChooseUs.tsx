  ...
  const reasons = [
    {
      icon: Network,
      number: "01",
      title: "Indian Supplier Sourcing",
      description:
        "We identify suitable Indian spice suppliers based on the buyer's required product, specifications, quantity, packaging, and commercial requirements.",
    },
    {
      ...
      description:
        "We explore suitable sourcing options and work with suppliers to develop commercial quotations based on product specifications and order requirements.",
    },
    {
      icon: ShieldCheck,
      number: "03",
      ...
      description:
        "We coordinate product specifications, quality requirements, testing needs, and relevant documentation with suppliers before the order and shipment stages.",
    },
    {
      icon: Boxes,
      number: "04",
      ...
      description:
        "We coordinate packaging, export documentation, logistics, and shipment requirements with the relevant suppliers and logistics partners.",
    },
    {
      ...
      description:
        "Spice variety, grade, quantity, packaging, specifications, documentation, and destination requirements can be discussed according to each enquiry.",
    },
    {
      icon: Globe2,
      number: "06",
      title: "India-to-Global Trade",
      description:
        "We help international buyers source Indian spices including turmeric, red chilli, coriander, cumin, black pepper, cardamom, and other selected spices.",
    },
  ];
      ...
      <div className="mx-auto max-w-7xl px-5 sm:px-6 lg:px-8">
        ...
        <div className="mx-auto max-w-4xl text-center">
          ...
          <p className="mx-auto mt-6 max-w-3xl text-base leading-8 text-slate-600 md:text-lg">
            We focus on making the sourcing and export process from India
            clear and organized, helping international buyers coordinate
            suitable spices, suppliers, commercial requirements, documentation,
          ...
          <div className="grid gap-8 md:grid-cols-[1fr_auto] md:items-center">
            ...
            <div>
              ...
              <p className="mt-4 max-w-3xl text-sm leading-7 text-slate-300 md:text-base">
                Every spice export enquiry is approached around the buyer&apos;s
                specific product, quantity, specifications, packaging,
